...
#define GT_BUFFERED_OUTPUT_FILE_FORCE_DUMP_SIZE GT_BUFFER_SIZE_8M
...
GT_INLINE void gt_buffered_output_file_dump(gt_buffered_output_file* const buffered_output_file) {
  GT_BUFFERED_OUTPUT_FILE_CHECK(buffered_output_file);
  buffered_output_file->buffer = gt_output_file_dump_buffer(buffered_output_file->output_file,buffered_output_file->buffer);
