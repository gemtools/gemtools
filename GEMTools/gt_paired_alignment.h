 ...
 * FILE: gt_paired_alignment.h
 * DATE: 01/06/2012
 * DESCRIPTION: // TODO
 */

#ifndef GT_PAIRED_ALIGNMENT_H_
#define GT_PAIRED_ALIGNMENT_H_

#include "gt_commons.h"
#include "gt_template.h"

typedef gt_template gt_paired_alignment;

/*
 * Checkers
 */
#define GT_PAIRED_ALIGNMENT_CHECK(paired_alignment) \
  gt_fatal_check(paired_alignment==NULL,NULL_HANDLER); \
  gt_check(gt_template_get_num_blocks(paired_alignment)!=2, \
    PALIGN_BAD_NUM_BLOCKS,gt_template_get_num_blocks(paired_alignment))
