 ...
 */
#define GT_MAP_IS_SAME_SEGMENT(map_1,map_2) (gt_string_equals(gt_map_get_string_seq_name(map_1),gt_map_get_string_seq_name(map_2)) && gt_map_get_strand(map_1)!=gt_map_get_strand(map_2))
